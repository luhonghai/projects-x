...
@Mojo(name = "restart-service")
public class RestartService extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        MojoCMG.init(getLog());
        ServiceCommand command = new ServiceCommand(ServiceCommand.RESTART, serviceName, remoteServer);
        command.execute();
    }
}
