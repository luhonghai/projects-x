...
@Mojo(name = "stop-service")
public class StopService extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        MojoCMG.init(getLog());
        ServiceCommand command = new ServiceCommand(ServiceCommand.STOP, serviceName, remoteServer);
        command.execute();
    }
}
